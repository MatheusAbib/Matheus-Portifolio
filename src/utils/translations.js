...
hero_desc_1: "Sou <strong>desenvolvedor de software</strong> há cerca de 4 anos, atuando com tecnologias <strong>front-end e back-end</strong> em projetos que vão desde sistemas para a Prefeitura de Mogi das Cruzes até aplicações próprias que publiquei e usei para aprender na prática.",
hero_desc_2: "Sou formado em <strong>Análise e Desenvolvimento de Sistemas</strong> pela Fatec de Mogi das Cruzes (2023-2026), o lugar que me deu minha primeira base para meu crescimento como programador. Atualmente curso <strong>Engenharia de Software</strong> na Universidade de Mogi das Cruzes e meu objetivo é aperfeiçoar o que eu mais gosto: <strong>programar</strong>.",
hero_desc_3: "Tenho experiência com <strong>Scrum e Kanban</strong> (sprints, boards, papéis do time), <strong>levantamento de requisitos</strong> (regras de negócio, BPMN, documentação) e <strong>controle de qualidade</strong>.<br>Com minha prática profissional e formação acadêmica, busco entregar projetos bem estruturados.",
...
exp_1_text: "<ul><li>Configuração e testes de qualidade (QA) em sistemas de chatbot corporativos.</li><li>Atendimento direto a clientes para levantamento de necessidades e resolução de problemas técnicos.</li><li>Organização do fluxo de tarefas com Trello, garantindo prazos e qualidade.</li></ul>",
exp_2_title: "Prefeitura de Mogi das Cruzes",
exp_2_role: "Estágio em Desenvolvimento de Software",
exp_2_period: "2025 - Presente",
exp_2_text: "<ul><li>Desenvolvimento de aplicações para as secretarias de Mogi das Cruzes, automatizando fluxos de trabalho e melhorando a eficiência operacional.</li><li>Utilização de Angular, TypeScript e Spring Boot.</li><li>Levantamento de requisitos diretamente com os setores internos para garantir soluções alinhadas às necessidades reais.</li></ul>",
...
project_forca_desc: "Jogo da forca com múltiplas categorias (animais, frutas, profissões), dicas visuais e contador de tentativas.",
project_crud_desc: "Sistema de cadastro completo com operações de criar, ler, atualizar e deletar, com validação de formulários.",
project_dashboards_desc: "Portfólio organizado com links para dashboards Power BI com visualizações de dados de vendas, financeiro e métricas de desempenho.",
project_tarefas_desc: "Gerenciador de tarefas com drag and drop, categorias personalizáveis, prioridades e filtros por status.",
project_uno_desc: "Versão digital do jogo UNO com regras oficiais, multiplayer local e interface animada.",
project_editor_desc: "Editor de imagens no navegador com ajustes de brilho, contraste, saturação, filtros pré-definidos e download da imagem editada.",
project_notas_desc: "Bloco de notas com persistência local (LocalStorage), formatação básica (negrito, itálico) e organização por data.",
project_sucos_desc: "Site institucional para loja de sucos naturais com cardápio interativo, descrição de produtos e informações de contato.",
...
project_todolist_desc: "Lista de tarefas desenvolvida com Angular e TypeScript, com adição, remoção, edição e persistência de dados.",
project_personagens_desc: "Caderno digital para criação de personagens de RPG com atributos, habilidades, histórico e sistema de evolução.",
project_figma_links_desc: "Portfólio organizado com links para projetos de UI/UX desenvolvidos no Figma, com previews e descrições.",
...
project_desfumo_desc: "Aplicativo para controle de consumo de tabaco com registro diário, metas de redução, acesso a unidades de saúde (UPAS) e recursos de apoio psicológico.",
    ...
    contact_info_text: "Estou disponível para novos projetos e oportunidades. Entre em contato!",
...
hero_desc_1: "I'm a <strong>software developer</strong> with about 4 years of experience, working with <strong>front-end and back-end</strong> technologies on projects ranging from systems for the Mogi das Cruzes City Hall to personal applications I published and used to learn by doing.",
hero_desc_2: "I graduated in <strong>Systems Analysis and Development</strong> from Fatec Mogi das Cruzes (2023-2026), the place that gave me my first foundation for my growth as a programmer. I'm currently studying <strong>Software Engineering</strong> at the University of Mogi das Cruzes and my goal is to improve what I love most: <strong>programming</strong>.",
hero_desc_3: "I have experience with <strong>Scrum and Kanban</strong> (sprints, boards, team roles), <strong>requirements gathering</strong> (business rules, BPMN, documentation) and <strong>quality control</strong>.<br>With my professional practice and academic background, I seek to deliver well-structured projects.",
hero_desc_4: "Here in my portfolio you'll discover much more about me!",
    cv_button: "Download CV",
...
feature_1_text: "<strong>I develop</strong> with Angular, React, Spring Boot and Node.js. Currently exploring Flutter and Dart.",

feature_2_title: "Agile Methodologies",
feature_2_text: "<strong>I work</strong> directly with clients to gather requirements and validate deliveries. Practical experience in technical documentation and business rules.",
...
exp_2_text: "Development of applications for the Health and Sports departments, replacing manual paper and Excel processes with digital systems. Using Angular, TypeScript and Spring Boot. Requirements gathering directly with internal departments to ensure solutions aligned with real needs.",
    ...
    contact_info_text: "I'm available for new projects and opportunities. Get in touch!",
