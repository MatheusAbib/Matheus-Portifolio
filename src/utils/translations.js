...
hero_desc_1: "I'm a software developer with about 4 years of experience, working with <strong>front-end and back-end</strong> technologies on projects ranging from systems for the Mogi das Cruzes City Hall to personal applications I published and used to learn by doing.",
hero_desc_2: "I graduated in <strong>Systems Analysis and Development</strong> from Fatec Mogi das Cruzes (2023-2026), the place that gave me my first foundation for my growth as a programmer. I'm currently studying <strong>Software Engineering</strong> at the University of Mogi das Cruzes and my goal is to improve what I love most: programming.",
hero_desc_3: "I have experience with <strong>agile methodologies</strong> like Scrum, requirements gathering, quality control and systems documentation. I seek to combine my professional practice with my academic background to deliver <strong>well-structured projects</strong>, from requirements gathering to final delivery.",
hero_desc_4: "Here in my <strong>portfolio</strong> you'll discover much more about me!",
    cv_button: "Download CV",
