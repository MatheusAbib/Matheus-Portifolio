...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  try {
    ...
    $mail->Password = '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';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port = 587;

    $mail->setFrom('bilitardomatheus@gmail.com', $name);
    $mail->addAddress('bilitardomatheus@gmail.com');

    $mail->isHTML(true);
    $mail->Subject = "Contato do site"; // sem assunto dinâmico
